...
(function ($) {
  ...
  Mavo.Plugins.register("firebase-firestore", {
    dependencies: ["https://dmitrysharabin.github.io/mavo-firebase-firestore/mavo-firebase-firestore.css"],
    hooks: {
  ...
  const _ = Mavo.Backend.register($.Class({
    ...
    store: function store(data, {
      ...
      return this.db.doc(this.filename).set(data).then(() => Promise.resolve()).catch(error => {
        Mavo.warn(this.mavo._("firebase-enable-auth"));
        Mavo.warn(this.mavo._("firebase-check-security-rules"));
