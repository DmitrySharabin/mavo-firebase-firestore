...
| ----------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| `mv-storage`      | `projectId`<br />(see [Step 3](#step-3-register-your-app-with-firebase)) | `mv-storage="firebase://mavo-demos"`. <br />**Note**: You can also use this value in other attributes: `mv-source`, `mv-init`, and `mv-uploads`. |
